...
class TestGCLogParser < Test::Unit::TestCase
  ...
  def test_format_line
    formated_line = @parser.format_line("10.082: [GC [PSYoungGen: 131072K->4966K(152896K)] 134940K->8835K(1551040K), 0.0172760 secs]")
    assert_equal("2009-09-05 02:55:10.082: [GC [PSYoungGen: 131072K->4966K(152896K)] 134940K->8835K(1551040K), 0.0172760 secs]", formated_line)
  end
  
  def test_format_millisecond
    base_time = Time.gm(2009,10,13,18,12,00)
    assert_equal("001", GCLogParser.format_millisecond(base_time + 0.001))
    assert_equal("010", GCLogParser.format_millisecond(base_time + 0.010))
    assert_equal("099", GCLogParser.format_millisecond(base_time + 0.099))
    assert_equal("100", GCLogParser.format_millisecond(base_time + 0.100))
    assert_equal("101", GCLogParser.format_millisecond(base_time + 0.101))
  end
end
